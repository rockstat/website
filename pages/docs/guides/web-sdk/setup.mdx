...
[[chapter]]
| [Параметры сниппета](/docs/reference/web-sdk/snippet-and-configuration/)

[[chapter]]
| [Web-SDK JacaScript API](/docs/reference/web-sdk/js-api/)

[[chapter]]
| [Автоматические события](/docs/reference/web-sdk/auto-track/)
