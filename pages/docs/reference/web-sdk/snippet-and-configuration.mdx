...
Происходит объединение событий в сессии, классификация на рекламные, органические (поиск), социальные, прямые, внутренние и реферальные.
Также можно добавить сколько угодно произвольных событий с произвольным набором параметров.
...
3. Не сработает adblock, так как платформа расположена на вашем домене, и она не будет блокироваться, в отличии от GTM
