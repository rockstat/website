...
[Узнать больше о сессиях →](/docs/reference/web-sdk/sessions).
...
<Info>
  Актуальная версия сниппета в репозитории на гитхабе → <a
...
3. Не сработает adblock, ведь платформа расположена на вашем домене и он не будет блокироваться, в отличие от GTM
