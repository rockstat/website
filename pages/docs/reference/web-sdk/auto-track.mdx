...
<Alert>
  Value сейчас не отправляется по соображениям безопасности
</Alert>
...
<Alert>
  ...
  Необходимо активировать trackActivity: {allClicks: true} [в настройках сниппета](/docs/reference/web-sdk/snippet-and-configuration/).
</Alert>

<Alert>
  Активация не меняет поведение отслеживания кликов по ссылкам.
