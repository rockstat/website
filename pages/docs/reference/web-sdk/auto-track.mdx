...
Просмотры страниц могут содержать данные о странице, например, тип страницы или категории.
...
Это одни из самых важных автоматических событий, по ним можно понимать, где произошла проблема
...
Сами данные позиции находятся в `scroll` [общей структуры данных](alcojs-data-format)
